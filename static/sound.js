...
$(window).load(function() {
  ...
  setTimeout(function() {
    $('<div class="message new"><figure class="avatar"><img src="/static/robo1.jpg" /></figure>' + 'Hello! I am here to help you with simple home remedies for everyday health issues and provide Ayurvedic solutions for lifestyle disorder and chronic conditions. How can I assist you today?' + '</div>').appendTo($('.mCSB_container')).addClass('new');
        setDate();
        updateScrollbar();
        textToSpeech('Hello! I am here to help you with simple home remedies for everyday health issues and provide Ayurvedic solutions for lifestyle disorder and chronic conditions. How can I assist you today?' );
  }, 100);
});
